(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.mySkey = {}));
	...
	const htmlEncode = (str) => {
	    ...
	    const result = str.replace(new RegExp(regStr, "gi"), function (t) {
	        const item = htmlCharset.find((item) => item.label === t);
	        return item.key;
	    });
	    return result;
	};
	const htmlDecode = (str) => {
	    ...
	    const result = str.replace(new RegExp(regStr, "gi"), function (t) {
	        const item = htmlCharset.find((item) => item.key === t);
	        return item.label;
	    });
	    return result;
	};
